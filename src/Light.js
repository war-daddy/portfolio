...
const ProjectCard = (name,year,source,link) =>{
    return (<>
     <div className='p-card p-3 mt-3'>
        ...
        <a role='button' href={source} target='_blank' className='btn btn-secondary' style={{color:'black'}}>Demo <FaExternalLinkAlt/></a>
        </div>
     </div>
    </>);
}
  ...
  return (
    ...
    <div className="light">
      ...
      <section className='ml'>
       ...
       <div className='mt-3 fs-5'>Last working at <a href='https://10times.com' target='_blank' className='fw-bold'>10Times</a> as a Software developer</div>
      </section>
       ...
       <section className='ml mt-5'>
        ...
        {ProjectCard("Crypto Tracker","2022","","https://aesthetic-sunshine-4ec466.netlify.app/")}
        {ProjectCard("Dsa Simulator","2023","https://github.com/war-daddy/dsasimulator_hub.github.io")}
        {ProjectCard("React Password Generator","2024","https://github.com/war-daddy/React_Reason")}
        {ProjectCard("JSONformatter","2024","https://github.com/war-daddy/JSONformatter")}
        </div>
       </section>
